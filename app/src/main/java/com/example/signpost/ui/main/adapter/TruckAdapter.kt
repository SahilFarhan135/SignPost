package com.example.signpost.ui.main.adapter

/*

class TruckAdapter(private val callback: TruckAdapterCallback) : RecyclerView.Adapter<TruckAdapter.TruckViewHolder>(), Filterable {
        ...
        fun bind(item: TruckItemEntity) {
            with(binding) {
                root.setOnClickListener {
                    callback.getLocationOnMap(item)
                }
...
interface TruckAdapterCallback{
    fun getLocationOnMap(item: TruckItemEntity)
}*/
